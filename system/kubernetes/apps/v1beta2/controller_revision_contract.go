...
type ControllerRevisionCreateRequest struct {
  service_ v1beta2.ControllerRevisionInterface
...
func (r * ControllerRevisionCreateRequest) SetService(service interface{}) error {
	var ok bool
	if r.service_, ok = service.(v1beta2.ControllerRevisionInterface); !ok {
		return fmt.Errorf("invalid service type: %T, expected: v1beta2.ControllerRevisionInterface", service)
	}
	return nil
}
...
func (r * ControllerRevisionCreateRequest) GetId() string {
	return "apps/v1beta2.ControllerRevision.Create";	
}
...
func (r * ControllerRevisionUpdateRequest) GetId() string {
	return "apps/v1beta2.ControllerRevision.Update";	
}
...
func (r * ControllerRevisionDeleteRequest) GetId() string {
	return "apps/v1beta2.ControllerRevision.Delete";	
}
...
func (r * ControllerRevisionDeleteCollectionRequest) GetId() string {
	return "apps/v1beta2.ControllerRevision.DeleteCollection";	
}
...
func (r * ControllerRevisionGetRequest) GetId() string {
	return "apps/v1beta2.ControllerRevision.Get";	
}
...
func (r * ControllerRevisionListRequest) GetId() string {
	return "apps/v1beta2.ControllerRevision.List";	
}
...
func (r * ControllerRevisionWatchRequest) GetId() string {
	return "apps/v1beta2.ControllerRevision.Watch";	
}
...
func (r * ControllerRevisionPatchRequest) GetId() string {
	return "apps/v1beta2.ControllerRevision.Patch";	
}
