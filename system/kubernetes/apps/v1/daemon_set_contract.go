...
type DaemonSetCreateRequest struct {
  service_ v1.DaemonSetInterface
  Set *vvc.DaemonSet
}
...
func (r * DaemonSetCreateRequest) SetService(service interface{}) error {
	var ok bool
	if r.service_, ok = service.(v1.DaemonSetInterface); !ok {
		return fmt.Errorf("invalid service type: %T, expected: v1.DaemonSetInterface", service)
	}
	return nil
}
...
func (r * DaemonSetCreateRequest) GetId() string {
	return "v1.DaemonSetInterface.Create";	
}
...
func (r * DaemonSetUpdateRequest) GetId() string {
	return "v1.DaemonSetInterface.Update";	
}
...
func (r * DaemonSetUpdateStatusRequest) GetId() string {
	return "v1.DaemonSetInterface.UpdateStatus";	
}
...
func (r * DaemonSetDeleteRequest) GetId() string {
	return "v1.DaemonSetInterface.Delete";	
}
...
func (r * DaemonSetDeleteCollectionRequest) GetId() string {
	return "v1.DaemonSetInterface.DeleteCollection";	
}
...
func (r * DaemonSetGetRequest) GetId() string {
	return "v1.DaemonSetInterface.Get";	
}
...
func (r * DaemonSetListRequest) GetId() string {
	return "v1.DaemonSetInterface.List";	
}
...
func (r * DaemonSetWatchRequest) GetId() string {
	return "v1.DaemonSetInterface.Watch";	
}
...
func (r * DaemonSetPatchRequest) GetId() string {
	return "v1.DaemonSetInterface.Patch";	
}
