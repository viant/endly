...
const (
	//ServiceID Kubernetes Batch service ID.
	ServiceID = "kubernetes/batch"
)
...
func (s *service) registerRoutes() {
	...
	s.registerClientRoutes(clientSet.BatchV1(), "Batch")
	s.registerClientRoutes(clientSet.BatchV1beta1(), "Batch")
}
