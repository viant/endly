...
//DialSessionRequest represents request
...
//SetContext sets context
func (r *DialSessionRequest) SetContext(ctx context.Context) {
	r.ctx = ctx
}

//SetService sets service
func (r *DialSessionRequest) SetService(service interface{}) error {
	var ok bool
	if r.service_, ok = service.(*client.Client); !ok {
		return fmt.Errorf("invalid service type: %T, expected: *client.Client", service)
	}
...
//Call calls service
func (r *DialSessionRequest) Call() (result interface{}, err error) {
	if r.service_ == nil {
		return nil, errors.New("service was empty")
	}
	result, err = r.service_.DialSession(r.ctx, r.Proto, r.Meta)
	return result, err
}

//GetId returns request id
func (r *DialSessionRequest) GetId() string {
	return "dialSessionRequest"
}
