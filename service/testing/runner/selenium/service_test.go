...
import (
	...
	endpoint "github.com/viant/endly/service/testing/endpoint/http"
	runner "github.com/viant/endly/service/testing/runner/selenium"
...
func TestSeleniumService_Calls(t *testing.T) {
	...
	if err = endly.Run(context, &runner.WebElementCallRequest{
		...
		Call: &runner.MethodCall{
			Method:     "Click",
			Parameters: []interface{}{},
			Wait:       &model.Repeater{ThinkTimeMs: 1},
		},
		Selector: &runner.WebElementSelector{
			By:    "css selector",
			Value: "#run",
