...
type AssetInput struct {
	ProjectID  string         `parameter:",kind=path,in=ProjectID" predicate:"exists,group=0,a,WORKFLOW_ID,w,WORKFLOW,ID,PROJECT_ID"`
	ID         []string       `parameter:",kind=form,in=id" predicate:"in,group=0,a,ID"`
