...
In reality most of these table may have many default value, and if only handful column (except IDs) have specific values for test use cases. 
Table mapping allow you to use one virtual table with virtual columns that are mapped to actual table/column.
